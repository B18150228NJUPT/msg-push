...
//        try {
//            List<File> files = CharSequenceUtil.isNotBlank(emailContentModel.getUrl())
//                    ? AustinFileUtils.getRemoteUrl2File(dataPath, CharSequenceUtil.split(emailContentModel.getUrl(), StrPool.COMMA)) : null;
